...
public class GengEllipticCurve
{
    ...
    public GengEllipticCurve(int n) throws IOException {
        ...
        BigInteger k = new BigInteger(n, new Random());

        FileWriter out1 = new FileWriter("input.txt");
    ...
    {
        int rInt = r.intValue();
        double a = Math.log10(rInt) / Math.log10(2);
        double b = (double)(2 * n + 2);
        if (a >= b)
            return true;
        return false;
    }
